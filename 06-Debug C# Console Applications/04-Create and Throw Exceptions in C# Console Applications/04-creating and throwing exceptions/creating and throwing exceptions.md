...
2. Verify that the sample application prints the following messages to the console:
...
3. Update the sample application using the following requirements:
...
4. Your completed solution must print the following messages to the console:
