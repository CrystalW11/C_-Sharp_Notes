...
2. Run the application in a debug session.

3. Use the Visual Studio Code debugger tools to isolate and fix the logic issues.

4. Save the updated the application.
...
2. Configure the application variables to meet the simulated transaction requirements in the **Specification** section.

3. Run your updated application.

4. Verify that your application achieves the following output requirements:
