...
2. Update the code so that each error message is displayed to the console when that exception type occurs.

3. Verify that your updated code prints the following messages to the console:
