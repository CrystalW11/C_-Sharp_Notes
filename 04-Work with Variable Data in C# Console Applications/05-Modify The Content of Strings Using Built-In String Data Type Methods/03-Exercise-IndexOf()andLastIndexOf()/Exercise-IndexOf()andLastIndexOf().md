...
2. pdate your code in the Visual Studio Code Editor as follows:
...
3. Update your code in the Visual Studio Code editor as follows:
...
5. Take a minute to review the code previously entered.
...
6. Update your code in the Visual Studio Code Editor as follows:
...
7. Take a few minutes to examine the previous code and to read the comments that help explain the code.

8. Continue examining the code and locate the following line of code using `IndexOf()` to define `closingPosition`:
...
9. Save your code file, and then use Visual Studio Code to run your code. You should see the following output:
