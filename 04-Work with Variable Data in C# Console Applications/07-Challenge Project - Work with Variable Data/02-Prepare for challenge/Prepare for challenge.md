...
- In a browser, open the link [Challenge-Project-variable-data-in-CSharp-main](https://github.com/CrystalW11/Challenge-Project-variable-data-in-CSharp-main) to download the zip file (Challenge-Project-variable-data-in-CSharp-main.zip).
...
2. Unzip the downloaded files locally (or in the sandbox if you aren't using a local dev environment)
    ...
    b. Right-click the Challenge-Project-variable-data-in-CSharp-main.zip file, and then select Extract all

    c. Make note of the extracted files location (the location of the root folder)
...
3. Open the root GuidedProject folder in Visual Studio Code
    ...
    c. Navigate to the folder that contains your extracted files, expand the folder structure to locate the folder named "Challenge-Project-variable-data-in-CSharp-main".

    d. Select **Challenge-Project-variable-data-in-CSharp-main** and then select **Select Folder**
