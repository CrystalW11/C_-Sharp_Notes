# Exercise-DiscoverSort()AndReverse()
...
2. In the EXPLORER panel, expand the **CsharpProjects** folder.

    You should see the TestProject folder and two files, a C# program file named Program.cs and a C# project file named TestProject.csproj.

3. In the EXPLORER panel, to view your code file in the Editor panel, select **Program.cs**.

4. Delete the existing code lines.
