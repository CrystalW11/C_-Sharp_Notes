...
1. Download a zip file containing the code folders for the guided project.
    ...
    - In a browser, navigate to  [`Guided-project-Work-with-variable-data-in-CSharp.zip`](https://github.com/CrystalW11/Guided-project-Work-with-variable-data-in-CSharp-main.git) to download the zip file.
