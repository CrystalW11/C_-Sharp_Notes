...
The Contoso Shopping Center is having a super sale! Many items have discounted price. You're given a list of item prices and a list of corresponding discounts. The discounts are represented by percentages, for example 50% = 0.5. If a customer spends more than **`30.00, thereceives5.00`** of their total purchase. In this task, you'll write code to calculate the customer's total. Let's get started!
...
2. Change the `GetDiscountedPrice` method to return a double by updating your code to the following:
...
3. Update the `GetDiscountedPrice` method with the following code:
...
4. Update the `GetDiscountedPrice` method with the following code:
...
5. Change the `TotalMeetsMinimum` method to return a `bool` by updating your code to the following:
...
6. Change the `FormatDecimal` method to return a `string` by updating your code to the following:
...
2. Update your code to the following:
...
3. Enter a new blank code line before `Console.WriteLine`, then add the following code:
...
4. Use `FormatDecimal` to format the displayed purchase price by updating your code as follows:
