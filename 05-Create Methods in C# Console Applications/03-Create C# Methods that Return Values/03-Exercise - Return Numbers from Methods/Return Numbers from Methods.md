...
3. Next, you'll add code to perform the conversion. Update the `UsdToVnd` method with the following code:
...
5. At the Terminal command prompt, enter **dotnet run** and compare your output with the following:
...
3. Update the `VndToUsd` method with the following code:
...
4. Locate the call to `Console.WriteLine` and append a new blank code line. Then enter the following code to call our new method and print the output:
