...
3. Enter a new blank code line and create `bool` method by entering the following code:
...
4. Consider how you'd check if a word is a palindrome.
...
5. Update the `IsPalindrome` method with the following code:
