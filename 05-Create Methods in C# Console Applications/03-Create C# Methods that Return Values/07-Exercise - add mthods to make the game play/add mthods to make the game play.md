...
2. Copy and paste the following code into the Editor panel.
...
3. Update the code to use methods to make the game run according to the challenge specifications.

    Use what you've learned about return values and parameters to complete the update.

4. Verify that your game is working
