...
6. Attempt to reference the variables inside of the `PrintCircleArea` method by updating your code as follows:
...
7. Delete the incorrect code and add the following code:
...
8. Update your code to the following:
...
9. Add a new method to your code as follows:
...
10. Save and run the code to observe the following output:
