...
3. Enter the following code in the `RSVP` method to search the guest list:
...
4. Call your method by adding the following code above the `RSVP` method signature:
...
5. Save and run the code to observe the following output:
...
2. Update the method call as follows:
...
3. Locate the following line of code: `RSVP("Tony", 1, "Jackfruit", true);`

4. Update the method call as follows:
...
3. Save and run the code to observe the following output:
