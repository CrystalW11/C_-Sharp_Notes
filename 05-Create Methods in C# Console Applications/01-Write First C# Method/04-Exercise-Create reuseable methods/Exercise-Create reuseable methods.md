# Exercise-Create reuseable methods
...
3. Notice that there's several `for`-loops that are repeated with identical code.
...
2. On the new blank code line, create a method signature by entering the following code:
...
3. To define the method body, update the `DisplayTimes` method by copy and pasting the `foreach` block as follows:
...
4. Enter a new blank code line at the end of the previous code.

5. On the new blank code line, create a method signature by entering the following code:
...
6. Update the `AdjustTimes` method by copy and pasting the for loop as follows:
...
2. Replace the code you identified with a call to the `DisplayTimes` method. The replacement should result in the following code:
...
4. Replace the code you identified with a call to the `DisplayTimes` method. The replacement should result in the following code:
...
6. Replace the instances of repeated code under the comment "Adjust the times by adding the difference" with calls to your `AdjustTimes` method. The replacement should result in the following code:
