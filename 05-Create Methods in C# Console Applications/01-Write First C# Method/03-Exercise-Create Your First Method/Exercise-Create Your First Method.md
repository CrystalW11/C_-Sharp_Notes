...
2. Enter the following code on the new blank code line:
...
3. Compare your code with the following to ensure it's correct:
...
1. Save your work using `Ctrl + S` or using the Visual Studio Code File menu.
...
3. At the Terminal command prompt, enter **dotnet run**

4. To verify that your code is working as expected, check that the output of your application is similar to the following output (taking into account the randomly generated numbers):
