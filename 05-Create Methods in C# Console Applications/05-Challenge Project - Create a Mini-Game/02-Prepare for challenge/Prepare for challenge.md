...
1. To download a zip file containing the Starter project code, select the following link:  [**`Lab Files`**](https://github.com/CrystalW11/Challenge-project-create-methods-in-CSharp-main.git).
...
b. Right-click **Challenge-project-Create-methods-in-CSharp.main.zip**, and then select **Extract all**.
