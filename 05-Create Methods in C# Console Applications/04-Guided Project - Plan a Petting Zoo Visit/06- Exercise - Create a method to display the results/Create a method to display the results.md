...
2. Add the following code to the `PrintGroup` method:
...
3. Update your method with the following code:
...
4. Locate the `PrintGroup` method call and remove the starting `//` characters.

    Next, you'll run your code and observe the results.

5. Save then run your code by entering dotnet run tt the Terminal command prompt.

6. To verify that your code is working as expected, check that the output of your application is similar the following output, taking into account the random order of the animals:
...
7. Create a new blank code line above the `RandomizeAnimals()` method call. Then create a new method by entering the following code:
...
8. Update your method with the following code:
...
9. Create a new blank code line above the `PlanSchoolVisit` method. Then enter the following code:
...
5. Check that the output of your application is similar to the following, taking into account the randomized order of animals:
