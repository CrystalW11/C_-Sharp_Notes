...
This code is just one***possible solution***, among many possible ways to achieve the same result. However, you should have used both the [**`Console.WriteLine()`**](https://learn.microsoft.com/en-us/dotnet/api/system.console.writeline?view=net-9.0#system-console-writeline) and [**`Console.Write(String)`**](https://learn.microsoft.com/en-us/dotnet/api/system.console.write?view=net-9.0#system-console-write(system-string)) methods to produce the desired output.
